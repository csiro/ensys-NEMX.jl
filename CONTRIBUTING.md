# Contributing to NEMX.jl

Bug reports, questions and pull requests are all welcome. This file covers what
the code expects; the same content is in the manual under *Contributing*.
