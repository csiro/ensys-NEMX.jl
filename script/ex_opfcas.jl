...
gurobi_solver = optimizer_with_attributes(Gurobi.Optimizer, "OutputFlag" => 0, "QCPDual" => 1, "NonConvex" => 2)  # , "NonConvex" => 2, "presolve" => 0, "FeasibilityTol" => 1E-2,"OptimalityTol" => 1E-2, "MIPGap" => 0.001 "NumericFocus" => 3, , "IntFeasTol" => 1E-5, 
