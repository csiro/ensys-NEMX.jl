...
isempty(stor) && error("No results in $DATA_DIR — run scripts/zbenchmark/run_bess_event_study.jl first.")
...
function write_table(path, lines)
    open(path, "w") do io
        println(io, "% Auto-generated by scripts/zbenchmark/analyse_bess_event_study.jl")
