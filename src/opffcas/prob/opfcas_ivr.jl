export run_acdcopfcas_ivr


""
function run_acdcopfcas_ivr(data::Dict{String,Any}, model_type::Type, solver; kwargs...)
...
# `KeyError: :bus_gens_dc` at build time.
    return _PM.solve_model(data, model_type, solver, build_acdcopfcas_ivr; ref_extensions=[_PMACDC.add_ref_dcgrid!, _PMACDC.ref_add_gendc!], solution_processors, kwargs...)
end

""
function build_acdcopfcas_ivr(pm::_PM.AbstractIVRModel)
