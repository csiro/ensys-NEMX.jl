...
# `KeyError: :bus_gens_dc` at build time.
    return _PM.solve_model(data, model_type, solver, build_master_scopfcas_bf; ref_extensions = [_PMACDC.add_ref_dcgrid!, _PMACDC.ref_add_gendc!], kwargs...)
end
...
function run_master_scopfcas_bf_soft(data::Dict{String,Any}, model_type::Type{T}, solver; kwargs...) where T <: _PM.AbstractBFModel
    return _PM.solve_model(data, model_type, solver, build_master_scopfcas_bf_soft; ref_extensions = [_PMACDC.add_ref_dcgrid!, _PMACDC.ref_add_gendc!], kwargs...)
end
...
function run_pb_sub_scopfcas_bf(data::Dict{String,Any}, model_type::Type{T}, solver; kwargs...) where T <: _PM.AbstractBFModel
    return _PM.solve_model(data, model_type, solver, build_pb_sub_scopfcas_bf; ref_extensions = [_PMACDC.add_ref_dcgrid!, _PMACDC.ref_add_gendc!], kwargs...)
end
...
#     return _PM.solve_model(data, model_type, solver, build_pb_sub_scopf_bf_soft; ref_extensions = [_PMACDC.add_ref_dcgrid!, _PMACDC.ref_add_gendc!], kwargs...)
# end
...
function run_f_sub_scopfcas_bf_soft(data::Dict{String,Any}, model_type::Type{T}, solver; kwargs...) where T <: _PM.AbstractBFModel
    return _PM.solve_model(data, model_type, solver, build_f_sub_scopfcas_bf_soft; ref_extensions = [_PMACDC.add_ref_dcgrid!, _PMACDC.ref_add_gendc!, _PMSC.ref_c1!], kwargs...)
end
...
function run_nc_sub_scopf_soft(data::Dict{String,Any}, model_type::Type, solver; kwargs...)
    return _PM.solve_model(data, model_type, solver, build_nc_sub_scopf_soft; ref_extensions = [_PMACDC.add_ref_dcgrid!, _PMACDC.ref_add_gendc!], kwargs...)
end
